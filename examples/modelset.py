...
i1 = Measurement(
    identifier="FEII_1.60/FEII_1.64",
    data=[0.1, 0.05, 0.2],
    uncertainty=StdDevUncertainty([0.025, 0.005, 0.05]),
    unit="",
)
i2 = Measurement(
    identifier="FEII_1.64/FEII_5.34", data=[0.3, 0.1, 1.0], uncertainty=StdDevUncertainty([0.1, 0.05, 0.25]), unit=""
)
mp.phasespace(
    ["FEII_1.60/FEII_1.64", "FEII_1.64/FEII_5.34"],
    nax2_clip=[10, 1e6] * u.Unit("cm-3"),
    nax1_clip=[1e3, 8e3] * u.Unit("K"),
    measurements=[i1, i2],
    errorbar=True,
)
