...
class TestAJPaperListings(unittest.TestCase):
    ...
    def test_listingA1(self):
        ...
        # WK
        mp = ModelPlot(ms)
        mp.plot("OI_145+CII_158/FIR", yaxis_unit="Habing", label=True, cmap="viridis", colors="k", norm="log")
        mp.savefig("example1a_figure.pdf")
        self._files.append("example1a_figure.pdf")
        # KT
        mpkt = ModelPlot(mskt)
        mpkt.plot("OI_145+CII_158/FIR", yaxis_unit="Habing", label=True, cmap="viridis", colors="k", norm="log")
    ...
    def test_listingA2(self):
        ...
        plot.ratios_on_models(
            yaxis_unit="Draine", colorbar=True, norm="log", cmap="cividis", label=True, ncols=3, figsize=(23, 7)
        )
    ...
    def test_listingA4(self):
        ...
        Measurement.make_measurement(cii_flux, cii_err, outfile=cii_combined, overwrite=True)
        Measurement.make_measurement(oi_flux, oi_err, outfile=oi_combined, overwrite=True)
